    ...
    <div class="mbx-rows">
      <?php $__empty_1 = true; $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <a class="<?php echo e($cls); ?>"
          href="<?php echo e($msgUrl); ?>"
          aria-label="<?php echo e($subject); ?> <?php echo e($isOutboxMsg ? 'to ' . ($toLine ?? '') : 'from ' . $fname); ?>">
    
          
          <?php if(!$isOutboxMsg): ?>
            <span class="mbx-rstar" aria-hidden="true"><?php echo e($isFlagged ? '★' : '☆'); ?></span>
          <?php else: ?>
          ...
          <span class="mbx-rcopy">
            <span class="mbx-rtop">
              <strong class="mbx-rfrom">
                <?php echo e($isOutboxMsg ? 'Me' : $fname); ?>

                <?php if($statePill): ?>
                  <span class="mbx-sp <?php echo e($statePill[0]); ?>" style="font-size:9px;padding:1px 6px"><?php echo e($statePill[1]); ?></span>
                <?php endif; ?>
              </strong>
              <time class="mbx-rtime" datetime="<?php echo e($msgTime?->toIso8601String()); ?>">
                <?php echo e($timeDisplay); ?>

              </time>
            </span>
    
            <div class="mbx-rsub"><?php echo e($subject); ?></div>
            <small class="mbx-rpre"><?php echo e($preview); ?></small>
    
            <?php if(!$isOutboxMsg && $email->has_attachments): ?>
              <span class="mbx-rtag">
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="mbx-empty">
          <div class="mbx-empty-ic">
            <i class="fa-regular <?php echo e($isOutboxFolder ? 'fa-paper-plane' : 'fa-envelope'); ?>" aria-hidden="true"></i>
          </div>
          <strong><?php echo e($isOutboxFolder ? 'No sent messages' : 'This folder is empty'); ?></strong>
          <span><?php echo e($isOutboxFolder ? 'Emails you send will appear here.' : 'Synchronize the account or adjust your filters.'); ?></span>
        </div>
      <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.builder360-classic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developer/public_html/builder360/resources/views/mailbox/external/show.blade.php ENDPATH**/ ?>